...
public class TestRun {
	public static void main(String[] args) {
		...
		Parent p2 = new Parent("김","양주시 고암길",2000,"G80");

		System.out.println("=======================");
		Child1 c1 = new Child1(); //자식 1 기본 생성자
		
		//Child1 자식의 기능
		c1.setComputer("삼성 갤럭시 북 4");
		...
		Child1 c2 = new Child1("2024 LG CRAM");
		...
		Child2 c3 = new Child2("최","서울시 강남구",9999999,"벤츠","아이폰 15");
		...
		ch1.testMethod();
		ch2.testMethod();
		// 부모에 코드 추가하면 모든 자식한테도 코드가 추가/수정된다
...
//		edu.kh.inheritance.model.dto2.Child2@6442b0a6
		...
		//Parent 오버라이딩
		// -> 오버라이딩된 Parent의 toString()을 Chid1/2가 상속 받음
//		toString() : 홍 / 서울시 중구 남대문로 120 / 100000000 / 그렌져
//		toString() : 홍 / 서울시 중구 남대문로 120 / 100000000 / 그렌져
//		toString() : 홍 / 서울시 중구 남대문로 120 / 100000000 / 그렌져
