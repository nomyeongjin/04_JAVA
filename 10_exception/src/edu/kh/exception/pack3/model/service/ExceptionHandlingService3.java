...
public class ExceptionHandlingService3 {
	...
	public void method4() {
		...
		try {
			...
			// -> 호출한 곳에서 처리
			// -> 예외 처리 코드(try-catch, throw) 작성

			System.out.print("두 번째 문자열 입력 : ");
			String str2 = inputString(); 
			
			// System.out.println(str1+str2); -> 효율이 좋지 않음
...
//				throw new MoreThanAHundredException();
				throw new MoreThanAHundredException("100을 초과하심");
			}
...
//			edu.kh.exception.pack3.model.exception.MoreThanAHundredException: 100을 초과하였습니다.
//			at edu.kh.exception.pack3.model.service.ExceptionHandlingService3.method5(ExceptionHandlingService3.java:217)
//			at edu.kh.exception.pack3.run.ExceptionHandlingRun3.main(ExceptionHandlingRun3.java:13)
