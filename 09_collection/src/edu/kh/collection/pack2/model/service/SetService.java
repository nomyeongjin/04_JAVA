...
public class SetService {
	...
	public void method1() {
		...
		System.out.println("비어있음 여부 : "+set.isEmpty());
	...
	public void method3() {
		...
		// A.equals(B) : A와 B가 가지고 있는 필드 값이 같다면 true, 아니라면 false
		...
		for(Person p : personSet) {
			System.out.println(p); // 25세 홍길동이 한번만 출력 (중복 제거)
		}
	 ...
	 * -> 기본 오름차순 정렬
	 * * 전제 조건 : 저장되는 객체는 Comparacle 인터페이스 상속 필수!
	 */
	public void method4() {
	...
	public void lottoNumberGenerator() {
		...
		for(int i=1,end = money/1000; i<=end ; i++) {
			// for문 반복 될때 마다 새로운 Set 객체를 생성
			Set<Integer> lotto = new TreeSet<Integer>();
